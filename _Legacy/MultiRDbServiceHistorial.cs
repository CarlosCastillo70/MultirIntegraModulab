...
namespace MultirIntegraModulab
{
    ...
    public partial class MultiRDbService
    {
        ...
        /// </summary>
        /// <param name="resultatMostra">Resultat de la mostra que ha canviat</param>
        ...
        /// <returns>True si s'ha guardat correctament</returns>
        public bool GuardarHistorialAutomaticMostra(ResultatProva resultatMostra, TipusIncorporacio tipusIncorporacio, string observacions = null)
        {
            if (resultatMostra == null)
            {
                Logger.Error("GuardarHistorialAutomaticMostra: resultatMostra és null");
                return false;
            }
            ...
            var microorganismes = resultatMostra.Microorganismes;
            var mecanismes = resultatMostra.MecanismesResistencia;
